...
class DatabaseSetup:
    ...
    def __init__(self, db_path: str = "database/support.db"):
...
y
    ...
    def create_tables(self):
        ...
        """)
        # this can be used for future purposes if this assistant is used for having conversation
        self.cursor.execute("""
...
def main():
    ...
    # Initialize database
    db = DatabaseSetup("database/support.db")
